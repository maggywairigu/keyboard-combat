ig.baked = true;
ig.module('game.menus.title').requires('game.menus.main', 'game.ease').defines(function() {
    ...
    MenuTitle = Menu.extend({
        ...
        scroll: 0,
        background: new ig.Image('media/background/range.jpg'),
        ztype: new ig.Image('media/title/title.png'),
        phoboslab: new ig.Image('media/title/phoboslab.png'),
        ship: new ig.Image('media/title/gun.png'),
